...
urlpatterns = [
    ...
    url(r'^mark-as-read/(?P<slug>[a-z0-9\-]+)/$', views.mark_as_read, name='mark_as_read'),
    url(r'^mark-as-unread/(?P<slug>[a-z0-9\-]+)/$', views.mark_as_unread, name='mark_as_unread'),
    url(r'^delete/(?P<slug>[a-z0-9\-]+)/$', views.delete, name='delete'),
